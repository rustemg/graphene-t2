...
class Deprecate(AbstractChange):
    def __init__(self, field_name, date_marked, date_to_do=None, replaced_by=None, comment=None):
...
class Alter(AbstractChange):
    def __init__(self, field_name, date_marked, date_to_do=None, comment=None, *, required):
        if comment is None:
